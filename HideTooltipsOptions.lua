...
local options = {
    type = "group",
    name = "Hide Tooltips v" .. VERSION .. " by Nayo",
    args = {
		...
		hideWarlock = {
            type = "toggle",
            name = "Hide Summoning Stone & Soulwell",
            desc = "Hide tooltip for Summoning Stone & Soulwell.",
            width = "full",
            order = 6,
            get = function() return Addon.db.profile.hideWarlock end,
            set = function(_, val) Addon.db.profile.hideWarlock = val end,
        },
